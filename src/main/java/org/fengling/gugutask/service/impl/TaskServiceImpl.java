...
public class TaskServiceImpl extends ServiceImpl<TaskMapper, Task> implements TaskService {
    ...
    @Override
    public List<TaskDetailsD> getTasksWithDetailsByUserIdAndTaskType(Long userId, Long taskType) {
        List<Map<String, Object>> taskDataList = taskMapper.getTasksWithDetailsByUserIdAndTaskType(userId, taskType);
